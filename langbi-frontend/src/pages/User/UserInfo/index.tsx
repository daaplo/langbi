...
} from '@/services/langbi/userController';
...
const UserInfo: React.FC = () => {
  ...
  return (
    <>
      <Divider style={{ fontWeight: 'bold', color: '#d4380d' }}>用户头像</Divider>
      ...
      <Divider style={{ fontWeight: 'bold', color: '#d4380d' }}>用户详细信息</Divider>
      <Descriptions
        bordered
        column={1}
        size={'default'}
        contentStyle={{ fontWeight: 'bold', color: ' #fa8c16', maxWidth: '200px' }}
      >
